...
from random_agent import berkePlayer
...
GmGame.start(player1=aiPlayer1,player2=aiPlayer3,max_time_to_move=1000,showIntermediateMoves=True) # don't speciry an aiPlayer for Human vs Human games
